...
from RtgsViaAccountNoScreen import RtgsViaAccountNoScreen
from RtgsViaMobileNumberScreen import RtgsViaMobileNumberScreen
from RtgsViaUpiScreen import RtgsViaUpiScreen
...
class MyFirstApp(MDApp):
    def build(self):
        try:
            ...
            self.sm.add_widget(RtgsViaAccountNoScreen())
            self.sm.add_widget(RtgsViaMobileNumberScreen())
