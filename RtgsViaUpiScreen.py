...
class RtgsViaUpiScreen(Screen):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.name='rtgs_via_upi_screen'
        ...
        self.enterBenificeryUpiTextField = MDTextField(mode='rectangle',
                                                        hint_text="Enter Benificery Upi",
        ...
        self.add_widget(self.enterBenificeryUpiTextField)
