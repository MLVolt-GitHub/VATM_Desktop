...
class OtpSendScreen(Screen):
    ...
    def onSendOtpButtonPressed(self, instance):
        mobNo = self.enterMobileNoTextField.text
        SendOtp().sendOtpNow(To=mobNo)
        self.otpSendStatusLabel.text="Otp has sent"
        RequiredFuns()._saveToLocalFile(key="mob", value=str(mobNo))
