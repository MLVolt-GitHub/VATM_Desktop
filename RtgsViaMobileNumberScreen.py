...
class RtgsViaMobileNumberScreen(Screen):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.name='rtgs_via_mobile_no_screen'
        ...
        self.enterBenificeryMobileNoTextField = MDTextField(mode='rectangle',
                                                            hint_text="Enter Registered Mobile Number",
        ...
        self.add_widget(self.enterBenificeryMobileNoTextField)
