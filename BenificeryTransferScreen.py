...
class BenificeryTransferScreen(Screen):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.name='benificery_transfer_screen'
        ...
        self.benificeryTransferLabel = MDLabel(text="BENIFICERY TRANSFER",
        ...
        self.add_widget(self.benificeryTransferLabel)
